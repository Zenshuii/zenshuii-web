      ...
      <div className="relative z-10 flex w-full max-w-xl flex-col items-center">
        ...
        <motion.div
          ...
          <Link
            ...
            className="inline-block cursor-pointer rounded-full bg-[var(--color-accent)] px-8 py-3 text-base font-semibold text-[var(--color-surface-3)] shadow-md transition-all duration-200 hover:scale-105 hover:bg-[var(--color-accent-weak)] hover:shadow-lg active:scale-95 sm:text-lg">
            Explore Stoic App
          </Link>
        </motion.div>
      </div>
