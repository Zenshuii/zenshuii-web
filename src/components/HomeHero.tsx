...
export function HomeHero() {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen text-center px-4 bg-white dark:bg-[#1C1C1C]">
      <motion.h1
        className="text-4xl sm:text-7xl font-bold mb-6 text-[#FFB877] tracking-tight"
