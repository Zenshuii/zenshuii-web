  ...
  return (
    <section className="relative flex w-full flex-1 flex-col items-center justify-center bg-gradient-to-br from-[var(--color-surface-2)] via-[var(--color-surface-3-a60)] to-[var(--color-surface-1)] px-4 pt-[72px] pb-[56px] sm:px-4">
      ...
      <motion.article
        ...
        className="relative z-10 mt-14 w-full max-w-3xl rounded-2xl border border-[var(--color-accent-a15)] bg-[var(--color-surface-2-a90)] p-3 text-center text-base shadow-xl sm:mt-14 sm:p-8 sm:text-lg md:text-left md:text-xl">
        <motion.h1
